...
#endif
#if MEMORY64
    // With MEMORY64 we have an addiional step to covert `p` arguments to
    // bigint. This is the runtime equivelent of the wrappers we create for wasm
    // exports in `emcc.py:create_wasm64_wrappers`.
    if (sig.includes('p')) {
      var new_args = [];
